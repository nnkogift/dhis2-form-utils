...
const plays = eventProgramRulesPlays('mantine');

function MantineEventProgramRulesForm() {
    return <ProgrammeEventForm Field={D2Field} Feedback={FormFeedback} />;
}

const meta = {
    title: 'mantine/Event Program Rules Example',
    component: MantineEventProgramRulesForm,
    tags: ['autodocs'],
    decorators: [
        (Story) => (
            <MantineProvider>
...
} satisfies Meta<typeof MantineEventProgramRulesForm>;
...
export const ShowWarningAboveHundred: Story = {
    parameters: {
        docs: {
            description: {
                story: 'Mantine adapters surface program-rule errors but not warnings. The number value is persisted while the (invisible) warning fires.',
            },
        },
    },
