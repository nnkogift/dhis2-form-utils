import { D2AgeField } from '@nnkogift/dhis2-form-utils-mantine';
...
const meta: Meta<typeof AgeFieldStory> = {
    title: 'mantine/Form Fields/D2AgeField',
    ...
    decorators: [
        ...
        withFormDecorators({ defaultValues: { [FIELD_ID]: '2000-01-01' } }),
    ],
};
export default meta;
...
export const ShowsComputedAge: Story = {
    play: async ({ canvas }) => {
        // D2AgeField folds the computed age into the underlying D2DateField's description.
