import { D2TimeField } from '@nnkogift/dhis2-form-utils-mantine';
...
const meta: Meta<typeof TimeFieldStory> = {
    title: 'mantine/Form Fields/D2TimeField',
...
export const Default: Story = {
    play: async ({ canvasElement }) => {
        ...
        // fireEvent.change avoids userEvent's flaky segmented keystroke handling on type="time".
