...
const plays = childProgrammeRegistrationPlays('mantine');
...
function MantineChildProgrammeRegistrationForm() {
    return <ProgrammeRegistrationForm Field={D2Field} />;
}

const meta = {
    title: 'mantine/Child Programme Registration Example',
    component: MantineChildProgrammeRegistrationForm,
    tags: ['autodocs'],
    decorators: [
        (Story) => (
            <MantineProvider>
...
} satisfies Meta<typeof MantineChildProgrammeRegistrationForm>;
