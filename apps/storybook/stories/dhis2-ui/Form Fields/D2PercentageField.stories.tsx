import { D2PercentageField } from '@nnkogift/dhis2-form-utils-dhis2-ui';
...
const meta: Meta<typeof PercentageFieldStory> = {
    title: 'dhis2-ui/Form Fields/D2PercentageField',
...
export const Default: Story = {
    play: async ({ canvas }) => {
        // D2PercentageField appends " (%)" to the underlying D2TextField's label.
        const input = canvas.getByRole('textbox', { name: /percentage label \(%\)/i });
