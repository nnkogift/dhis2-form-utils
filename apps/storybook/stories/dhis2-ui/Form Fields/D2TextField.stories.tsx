import { D2TextField } from '@nnkogift/dhis2-form-utils-dhis2-ui';
...
const meta: Meta<typeof TextFieldStory> = {
    title: 'dhis2-ui/Form Fields/D2TextField',
...
export const WithWarning: Story = {
    decorators: [
        withFormDecorators({
            defaultValues: { [FIELD_ID]: '' },
            fieldState: fieldStateFor(FIELD_ID, { warning: 'Please verify this value' }),
        }),
    ],
    play: async ({ canvas }) => {
        await expect(canvas.getByText('Please verify this value')).toBeInTheDocument();
    },
};
