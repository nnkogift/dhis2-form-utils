...
export const WithError: Story = {
  decorators: [
    withFormDecorators({ fieldState: fieldStateFor('sampleField', { error: 'Invalid value' }) }),
  ],
  args: { name: 'sampleField', label: 'Field with Error' },
};

export const Hidden: Story = {
  decorators: [withFormDecorators({ fieldState: fieldStateFor('sampleField', { hidden: true }) })],
