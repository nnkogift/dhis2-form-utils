...
const meta: Meta<typeof GeoJsonFieldStory> = {
    title: 'mui/Form Fields/D2GeoJsonField',
...
// MUI's Dialog renders in a portal outside the story root, so anything inside it is queried via
// the global `screen`, not the story-scoped `canvas`.
export const Default: Story = {
    play: async ({ canvas }) => {
        ...
        // MUI's Dialog unmounts its content asynchronously, after the exit transition.
