...
} satisfies Meta<typeof MuiAncForm>;
...
export const LowHemoglobinWarning: Story = {
    parameters: {
        docs: {
            description: {
                story: 'MUI adapters surface program-rule errors but not warnings. The hemoglobin value is still persisted.',
            },
        },
    },
